...
**Install:** open [`fut-sbc.user.js`](https://raw.githubusercontent.com/mljpa/fut-sbc-dist/main/fut-sbc.user.js) → Tampermonkey → Install.

**Update:** Tampermonkey dashboard → *Check for userscript updates*.

Current version: `0.1.0.1788466508`
